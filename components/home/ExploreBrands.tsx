            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-6">
                    {brands.map((brand: IBrand, index: number) => (
                        ...
                        >
                            <div className="w-full bg-[var(--component)] rounded-[14px] lg:rounded-[18px] flex items-center justify-center p-2 h-[160px] lg:h-[230px] md:h-[180px] relative shadow-[0_8px_25px_rgba(0,0,0,0.05)] group-hover:shadow-[0_15px_35px_rgba(0,0,0,0.1)] transition-all duration-300 group-hover:scale-105 overflow-hidden block">
                                <div className="relative w-[100%] h-[100%] rounded-[12px] lg:rounded-[16px] overflow-hidden">
                                    <Image
                                        src={process.env.NEXT_PUBLIC_GCORE_CDN_URL + "/" + brand.logo}
                                        alt={brand.name}
                                        fill
                                        className="object-contain rounded-[12px] lg:rounded-[16px]"
                                    />
                                </div>
                            </div>
