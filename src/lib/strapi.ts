...
const STRAPI_URLHomepage = process.env.NEXT_PUBLIC_STRAPI_URL + "/api/home-page?populate[hero][populate]=image&populate[promosAndOffers][populate][items][populate]=image&populate[features][populate][items][populate]=image&populate[moreFromCocaCola][populate][items][populate]=image&populate[socialLinks][populate][Instagram]=*&populate[socialLinks][populate][Youtube]=*&populate[socialLinks][populate][X]=*&populate[socialLinks][populate][Facebook]=*&populate[footer][populate][Section1][populate][links]=*&populate[footer][populate][Section2][populate][links]=*&populate[footer][populate][Section3][populate][links]=*&populate[footer][populate][FooterImage]=true&populate[NavbarImage]=true&populate[SEO][populate]=*";

if (!STRAPI_URLHomepage) {
    throw new Error("NEXT_PUBLIC_STRAPI_URL is missing");
}

const STRAPI_URLAboutUs = process.env.NEXT_PUBLIC_STRAPI_URL + "/api/about-page?populate[Hero][populate]=HeroBanner&populate[MainPageCards][populate][items][populate]=image&populate[RelatedSectionCards][populate][items][populate]=image&populate[SEO][populate]=*";
if (!STRAPI_URLAboutUs) {
    throw new Error("NEXT_PUBLIC_STRAPI_URL is missing");
}

const STRAPI_URLContactUs = process.env.NEXT_PUBLIC_STRAPI_URL + "/api/contactus-page?populate[FAQ][populate][question_answer]=*&populate[SEO][populate]=*";
...
const STRAPI_URLManufacturing = process.env.NEXT_PUBLIC_STRAPI_URL + "/api/manufacturing-list?populate[Section_table][populate][Section_Table_Row]=*&populate[SEO][populate]=*";
...
const STRAPI_URLExtension = process.env.NEXT_PUBLIC_STRAPI_URL + "/api/extension-page?populate[Row]=*&populate[SEO][populate]=*";
if (!STRAPI_URLExtension) {
    throw new Error("NEXT_PUBLIC_STRAPI_URL is missing")
}
const STRAPI_URLCobranding = process.env.NEXT_PUBLIC_STRAPI_URL + "/api/cobranding?populate[Card1][populate]=*&populate[card2][populate]=*&populate[SEO][populate]=*";
