...
export async function generateMetadata(): Promise<Metadata> {
    ...
    return {
        title: seo?.metaTitle || `${SITE_CONFIG.pages.cobranding.title} | ${SITE_CONFIG.companyName}`,
        description: seo?.metaDescription || SITE_CONFIG.pages.cobranding.description,
