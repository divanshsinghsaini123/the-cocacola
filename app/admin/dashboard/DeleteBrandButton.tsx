                    ...
                    >
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 pt-1">
                                <h3 className="text-lg font-bold text-gray-900 leading-none">Delete Brand</h3>
                                <p className="mt-2 text-sm text-gray-500">
                                    Are you sure you want to delete this brand? This action will permanently remove the brand and <strong>all associated products</strong>.
                                </p>
                            </div>
                        </div>
