...
export default function InstamartInventoryPage() {
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-gray-900">
                                Instamart Pincode Inventory
                            </h1>
                            <p className="text-sm text-gray-500">
                                Swiggy Instamart inventory catalog organized by area pincodes. Click any pincode accordion to view product details.
                            </p>
                        </div>
                    </div>
                </div>
